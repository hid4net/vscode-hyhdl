...
function activate(context) {
    ...
    let vlgInstTb = new codeTemplate.vlgInstTb(context) // myCode: instantiate a object
    ...
    //---------- documentation ----------
    let myDocumentor = new documentation.documentor(context) // myCode: instantiate a object
